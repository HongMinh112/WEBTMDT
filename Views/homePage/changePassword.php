...
<body>
    ...
    <div style="background-color: rgb(228, 228, 228);display: flex; margin-bottom: 20px;">
        <div class="form_member" style="margin-left: 430px;">
            <span>Đăng Nhập</span>
            <form action="../../controler/homePage/changePassword.php" method="post">
                <input style="padding-left:20px;margin-left:20px;" type="password" name="password" placeholder="Mật khẩu cũ...">
                <br>
                <input style="padding-left:20px;margin-left:20px;" type="password" name="passwordnews" placeholder="Mật Khẩu mới...">
                <br>
                <input style="padding-left:20px;margin-left:20px;" type="password" name="passwordChange" placeholder="Nhập lại mật khẩu mới...">
                <div>
                    <input style="margin-bottom: 10px;" type="submit" name="change" value="Cập Nhật">
                </div>
            </form>
        </div>
    </div>
